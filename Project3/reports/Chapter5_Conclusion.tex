...
Chapter~\ref{chap:background}, namely the reliance on a single detection
...
\begin{romanlist}
  \item \textbf{A working three-tier hybrid detector.} The system combines a
        ...
        Chapter~\ref{chap:solution}, is the core contribution of the thesis.
  ...
  \item \textbf{Strong, recall-oriented results.} As reported in
        Chapter~\ref{chap:evaluation}, the supervised tier alone reaches an F1
...
\begin{romanlist}
  ...
  \item \textbf{From detection to prevention.} Finally, the system could be
