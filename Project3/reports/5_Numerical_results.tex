...
\begin{table}[H]
  \centering
  \caption{Composition of the raw corpus before balancing.}
  \label{tab:sources}
...
\begin{table}[H]
  \centering
  \caption{Performance of the individual detectors (\%).}
...
\begin{figure}[H]
  ...
  \caption{Precision, recall, F1 and F2 of every model.}
  \label{fig:metrics}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Ranking of the detectors by F1 score.}
  \label{fig:f1rank}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Random Forest feature importance (Gini), ranked high to low.}
  \label{fig:featimp}
\end{figure}

\begin{table}[H]
  \centering
  \caption{Leading Random Forest features by Gini importance.}
  \label{tab:featimp}
  \renewcommand{\arraystretch}{1.25}
  \setlength{\tabcolsep}{8pt}
  \footnotesize
...
\begin{table}[H]
  \centering
  \caption{Tiers versus hybrid fusion strategies (\%).}
  \label{tab:hybrid}
  \renewcommand{\arraystretch}{1.35}
  \setlength{\tabcolsep}{9pt}
  \footnotesize
...
\begin{figure}[H]
  ...
  \caption{Tier and hybrid comparison across the four metrics.}
...
\begin{figure}[H]
  ...
  \caption{Radar comparison of the three strongest configurations.}
  \label{fig:radar}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Confusion matrices of the eight configurations.}
  \label{fig:confusion}
\end{figure}
...
\begin{table}[H]
  \centering
  \caption{Cross-dataset results of the three-tier system (\%).}
