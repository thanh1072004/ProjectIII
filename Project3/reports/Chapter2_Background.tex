...
features~\cite{pham2016}, trained by maximum likelihood. Pham et
al.~\cite{pham2016} note that it suits binary classification well and has
low variance, so it is less prone to overfitting. In the thesis it serves
...
methods based on a global threshold tend to miss. In the thesis, LOF is
...
corresponding to a smaller average depth in the tree. The advantage of the
...
anomalous. By using a kernel function---typically the radial basis function
(RBF) kernel as in the thesis---the One-Class SVM can describe complex
non-linear boundaries. Because the algorithm is sensitive to feature scale,
the thesis applies a scaling step before training. The model attains a
...
\bibitem{pham2016}
T.~S. Pham, T.~H. Hoang, and V.~C. Vu,
``Machine learning techniques for web intrusion detection -- a comparison,''
in \emph{Proc. 8th Int. Conf. on Knowledge and Systems Engineering (KSE)},
IEEE, 2016, pp. 291--297.

\bibitem{althubiti2017}
S.~Althubiti, X.~Yuan, and A.~Esterline,
``Analyzing HTTP requests for web intrusion detection,''
in \emph{KSU Proc. on Cybersecurity Education, Research and Practice}, 2017.

\bibitem{nguyen2011}
H.~T. Nguyen et al.,
``Application of the generic feature selection measure in detection of web
attacks,''
in \emph{Computational Intelligence in Security for Information Systems}.
Berlin: Springer, 2011, pp. 25--32.

\bibitem{csic2010}
C.~T. Gim\'{e}nez, A.~P. Villegas, and G.~\'{A}. Mara\~{n}\'{o}n,
``HTTP Dataset CSIC 2010,''
CSIC (Spanish Research National Council), 2010. [Online]. Available:
\url{http://www.isi.csic.es/dataset/}

\bibitem{rawashdeh2023}
S.~Rawashdeh,
``Cybersecurity in machine learning techniques: Detecting network attacks,''
\emph{Acta Scientific Computer Sciences}, vol.~5, no.~11, pp. 21--29, 2023.

\bibitem{kim2020}
A.~Kim et al.,
``AI-IDS: Application of deep learning to real-time web intrusion
detection,''
\emph{IEEE Access}, vol.~8, pp. 70245--70261, 2020.

\bibitem{vartouni2018}
A.~M. Vartouni et al.,
``An anomaly detection method to detect web attacks using stacked
auto-encoder,''
in \emph{6th Iranian Joint Congress on Fuzzy and Intelligent Systems
(CFIS)}, 2018, pp. 131--134.

\bibitem{betarte2018}
G.~Betarte et al.,
``Web application attacks detection using machine learning techniques,''
in \emph{17th IEEE Int. Conf. on Machine Learning and Applications
(ICMLA)}, 2018, pp. 1065--1072.

\bibitem{tsai2009}
C.-F. Tsai, Y.-F. Hsu, C.-Y. Lin, and W.-Y. Lin,
``Intrusion detection by machine learning: A review,''
\emph{Expert Systems with Applications}, vol.~36, no.~10,
pp. 11994--12000, 2009.

\bibitem{owasp2021}
OWASP Foundation,
``OWASP Top 10:2021 -- A03:2021 Injection,'' 2021. [Online]. Available:
...
B.~Sch\"{o}lkopf, J.~C. Platt, J.~Shawe-Taylor, A.~J. Smola, and
R.~C. Williamson,
``Estimating the support of a high-dimensional distribution
(support vector method for novelty detection),''
\emph{Neural Computation}, vol.~13, no.~7, pp. 1443--1471, 1999.

\bibitem{breunig2000}
M.~M. Breunig, H.-P. Kriegel, R.~T. Ng, and J.~Sander,
``LOF: Identifying density-based local outliers,''
in \emph{Proc. 2000 ACM SIGMOD Int. Conf. on Management of Data},
Dallas, TX, 2000, pp. 93--104.

\bibitem{liu2008}
F.~T. Liu, K.~M. Ting, and Z.-H. Zhou,
``Isolation forest,''
in \emph{Proc. 8th IEEE Int. Conf. on Data Mining (ICDM)}, 2008,
pp. 413--422.
