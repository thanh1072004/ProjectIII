...
\begin{figure}[H]
  ...
  \caption{End-to-end processing flow of the proposed three-tier hybrid web intrusion
detection system.}
  \label{fig:pipeline}
\end{figure}
...
\begin{table}[ht]
  \centering
  \caption{The complete $22$-feature vector shared by the two machine-learning
    tiers, grouped as in the text. ``int'' denotes an integer-valued feature;
    \texttt{suspicious\_ua\_score}, \texttt{referer\_suspicion} and
    \texttt{status\_code\_indicator} take a small set of discrete levels.}
  \label{tab:features}
